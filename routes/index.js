...
let questionnaire = [
  ...
  [
    {
      question: "Is the submission easy to read and understand?",
      answers: [
        "Select your option",
    ...
    {
      question: "Is the submission enjoyable to read?",
      answers: [
        "Select your option",
    ...
    {
      question:
        "Does the submission include significant editorial and/or personal content that represents the writer’s experience or views?",
      answers: [
        "Select your option",
  ...
  [
    ...
    {
      question: "Technical difficulty of the graphics?",
      answers: [
        "Select your option",
...
router.get("/result/:cat/:num", function(req, res, next) {
  ...
  if (ans.indexOf("-") === -1) ans = Array.from(ans);
  else ans = ans.split("-");
  console.log(ans);
  if (ans[ans.length - 1] === "") ans.splice(-1, 1);
